...
export default function MeetingCheckPage() {
  ...
  const breadcrumbs = generateBreadcrumbListSchema([
    { name: t.breadcrumb_home, path: '/hi' },
    { name: t.meeting_check, path: '/hi/meeting-check' }
  ], locale)
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[{ name: t.meeting_check, path: '/hi/meeting-check' }]} locale={locale} />
      ...
      <StickyActionBar toolName={t.meeting_check} toolHref="/hi/meeting-check" />
    </>
  )
}
