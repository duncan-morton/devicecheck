...
export default function ScreenTestPage() {
  ...
  const breadcrumbs = generateBreadcrumbListSchema([
    { name: t.breadcrumb_home, path: '/pt' },
    { name: t.screen_test, path: '/pt/screen' }
  ], locale)
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[{ name: t.screen_test, path: '/pt/screen' }]} locale={locale} />
      ...
      <StickyActionBar toolName={t.screen_test} toolHref="/pt/screen" />
    </>
  )
}
