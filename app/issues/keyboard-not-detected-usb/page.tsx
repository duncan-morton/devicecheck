...
const faqs = [
  {
    "question": "Why is usb keyboard not detected?",
    "answer": "USB keyboard not recognised. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix usb keyboard not detected?",
    "answer": "First, check USB permissions and settings. Verify the correct keyboard is selected. Update drivers if needed. Use the keyboard test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes usb keyboard not detected?",
  ...
  {
    "question": "Can I fix usb keyboard not detected without technical knowledge?",
    "answer": "Yes. Most keyboard issues can be fixed by checking permissions in USB settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'USB Keyboard Not Detected - Complete Fix Guide',
    'Fix usb keyboard not detected. Step-by-step troubleshooting guide.',
    '/issues/keyboard-not-detected-usb',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"USB Keyboard Not Detected","path":"/issues/keyboard-not-detected-usb"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-not-detected-usb',
    name: 'USB Keyboard Not Detected',
    description: 'Fix usb keyboard not detected with clear steps for USB covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'USB Keyboard Not Detected', path: '/issues/keyboard-not-detected-usb' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">USB Keyboard Not Detected</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              USB keyboard not recognised. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="USB keyboard not recognised"
              platform="USB"
              deviceType="keyboard"
            />
            ...
            <p className="text-gray-700 mb-4">
              USB includes strict privacy controls that can block keyboard access. The system requires explicit permission for applications to use your keyboard, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. USB may not automatically install the correct drivers for your keyboard, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the keyboard simultaneously. USB allows only one application to use the keyboard at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "USB", slug: 'keyboard-not-detected-usb' }} />
            ...
            <p className="text-gray-700 mb-4">
              USB requires explicit permission for keyboard access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open USB settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open USB settings and navigate to keyboard permissions. Enable access for your application and restart if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              USB may be using the wrong keyboard or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or keyboard manufacturer's website. Download the latest drivers for USB and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">USB</h3>
            <p className="text-gray-700 mb-4">
              USB has specific settings for keyboard access. Follow these detailed steps for USB.
            </p>
            <p className="text-gray-700 mb-4">
              Open USB settings and navigate to keyboard permissions. Enable access for your application and restart if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep USB updated. System updates often include driver updates that can fix keyboard issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable keyboard access in privacy settings unless necessary. USB remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
