...
const issuePath = '/issues/microphone-not-working-safari'
const alternates = {
...
export default function IssuePage() {
  ...
  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Microphone Not Working in Safari","path":"/issues/microphone-not-working-safari"}]
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <IssueLinksPanel issue={{ slug: "microphone-not-working-safari", deviceType: "mic", platform: "Safari", title: "Microphone Not Working in Safari" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Safari", slug: 'microphone-not-working-safari' }} />
