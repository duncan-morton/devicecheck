...
const issuePath = '/issues/webcam-in-use-by-another-app'
export const metadata: Metadata = { ...genMeta({
  title: 'Webcam In Use by Another Application - Complete Fix Guide',
  description: 'Fix webcam in use by another application. Step-by-step troubleshooting guide covering All settings, permissions, drivers, and solutions for camera locked by another program.',
  path: issuePath,
  keywords: ["webcam in use","camera in use by another app","camera busy fix"]
}) }

const faqs = [
  {
    "question": "Why is webcam in use by another application?",
    "answer": "Camera locked by another program. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam in use by another application?",
  ...
  {
    "question": "What causes webcam in use by another application?",
  ...
  {
    "question": "Can I fix webcam in use by another application without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam In Use by Another Application - Complete Fix Guide',
    'Fix webcam in use by another application. Step-by-step troubleshooting guide.',
    '/issues/webcam-in-use-by-another-app',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam In Use by Another Application","path":"/issues/webcam-in-use-by-another-app"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-in-use-by-another-app',
    name: 'Webcam In Use by Another Application',
    description: 'Fix webcam in use by another application with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam In Use by Another Application', path: '/issues/webcam-in-use-by-another-app' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam In Use by Another Application</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Camera locked by another program on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Camera locked by another program"
              platform="All"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-in-use-by-another-app' }} />
