...
const issuePath = '/issues/microphone-muted-windows-11'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Microphone Muted on Windows 11 - Complete Fix Guide',
  description: 'Fix microphone muted on windows 11. Step-by-step troubleshooting guide covering Windows 11 settings, permissions, drivers, and solutions for windows 11 microphone stuck on mute or zero volume.',
  path: issuePath,
  keywords: ["microphone muted windows 11","windows 11 mic mute fix","mic volume locked at zero"]
}), alternates }

const faqs = [
  {
    "question": "Why is microphone muted on windows 11?",
    "answer": "Windows 11 microphone stuck on mute or zero volume. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone muted on windows 11?",
    "answer": "First, check Windows 11 permissions and settings. Verify the correct microphone is selected. Update drivers if needed. Use the microphone test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes microphone muted on windows 11?",
  ...
  {
    "question": "Can I fix microphone muted on windows 11 without technical knowledge?",
    "answer": "Yes. Most microphone issues can be fixed by checking permissions in Windows 11 settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
    "question": "How do I enable microphone in Windows 11?",
    "answer": "Open Settings → Privacy & Security → Microphone. Ensure access is turned on and \"Let desktop apps access your microphone\" is enabled. Restart your computer after changing these settings."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Muted on Windows 11 - Complete Fix Guide',
    'Fix microphone muted on windows 11. Step-by-step troubleshooting guide.',
    '/issues/microphone-muted-windows-11',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Microphone Muted on Windows 11","path":"/issues/microphone-muted-windows-11"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-muted-windows-11',
    name: 'Microphone Muted on Windows 11',
    description: 'Fix microphone muted on windows 11 with clear steps for Windows 11 covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Muted on Windows 11', path: '/issues/microphone-muted-windows-11' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Muted on Windows 11</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Windows 11 microphone stuck on mute or zero volume. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "microphone-muted-windows-11", deviceType: "mic", platform: "Windows 11", title: "Microphone Muted on Windows 11" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Windows 11 microphone stuck on mute or zero volume"
              platform="Windows 11"
              deviceType="mic"
            />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Enable microphone in Windows 11 Privacy settings</li>
              <li>Check that the correct microphone is selected</li>
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 includes strict privacy controls that can block microphone access. The system requires explicit permission for applications to use your microphone, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Windows 11 may not automatically install the correct drivers for your microphone, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Windows 11", slug: 'microphone-muted-windows-11' }} />
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 requires explicit permission for microphone access. Verify permissions are enabled in system settings.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              Press Windows key + I → Privacy & Security → Microphone. Turn on "Microphone access" and "Let desktop apps access your microphone". Scroll down and ensure your application is listed and enabled. Restart your computer after changing these settings.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Windows 11 may be using the wrong microphone or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or microphone manufacturer's website. Download the latest drivers for Windows 11 and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 has specific settings for microphone access. Follow these detailed steps for Windows 11.
            </p>
            <p className="text-gray-700 mb-4">
              Press Windows key + I → Privacy & Security → Microphone. Turn on "Microphone access" and "Let desktop apps access your microphone". Scroll down and ensure your application is listed and enabled. Restart your computer after changing these settings.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Windows 11 updated. System updates often include driver updates that can fix microphone issues.
            </p>
            <p className="text-gray-700 mb-4">
