...
const faqs = [
  {
    "question": "Why is microphone not working in chrome?",
    "answer": "Microphone not detected or no sound in Chrome browser. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
  ...
  {
    "question": "What causes microphone not working in chrome?",
  ...
  {
    "question": "Can I fix microphone not working in chrome without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working in Chrome - Complete Fix Guide',
    'Fix microphone not working in chrome. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-chrome',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Chrome & browser permission issues","path":"/hubs/chrome-permissions-issues"},{"name":"Microphone Not Working in Chrome","path":"/issues/microphone-not-working-chrome"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-chrome',
    name: 'Microphone Not Working in Chrome',
    description: 'Fix microphone not working in chrome with clear steps for Chrome covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Not Working in Chrome', path: '/issues/microphone-not-working-chrome' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working in Chrome</h1>
          ...
          <IssueLinksPanel issue={{ slug: "microphone-not-working-chrome", deviceType: "mic", platform: "Chrome", title: "Microphone Not Working in Chrome" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Microphone not detected or no sound in Chrome browser"
              platform="Chrome"
              deviceType="mic"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Chrome", slug: 'microphone-not-working-chrome' }} />
