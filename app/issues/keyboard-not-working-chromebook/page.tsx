...
const issuePath = '/issues/keyboard-not-working-chromebook'
export const metadata: Metadata = { ...genMeta({
  title: 'Keyboard Not Working on Chromebook - Complete Fix Guide',
  description: 'Fix keyboard not working on chromebook. Step-by-step troubleshooting guide covering Chromebook settings, permissions, drivers, and solutions for chromebook keyboard unresponsive or missing input.',
  path: issuePath,
  keywords: ["keyboard not working chromebook","chromebook keys not responding","chromeos keyboard fix"]
}) }

const faqs = [
  {
    "question": "Why is keyboard not working on chromebook?",
    "answer": "Chromebook keyboard unresponsive or missing input. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix keyboard not working on chromebook?",
    "answer": "First, check Chromebook permissions and settings. Verify the correct keyboard is selected. Update drivers if needed. Use the keyboard test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes keyboard not working on chromebook?",
  ...
  {
    "question": "Can I fix keyboard not working on chromebook without technical knowledge?",
    "answer": "Yes. Most keyboard issues can be fixed by checking permissions in Chromebook settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Keyboard Not Working on Chromebook - Complete Fix Guide',
    'Fix keyboard not working on chromebook. Step-by-step troubleshooting guide.',
    '/issues/keyboard-not-working-chromebook',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Chrome & browser permission issues","path":"/hubs/chrome-permissions-issues"},{"name":"Keyboard Not Working on Chromebook","path":"/issues/keyboard-not-working-chromebook"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-not-working-chromebook',
    name: 'Keyboard Not Working on Chromebook',
    description: 'Fix keyboard not working on chromebook with clear steps for Chromebook covering permissions, device selection, and drivers.',
    steps: [{"title":"Check keyboard connections","description":"Check keyboard connections"},{"title":"Test keyboard on another","description":"Test keyboard on another computer"},{"title":"Update keyboard drivers","description":"Update keyboard drivers"},{"title":"Check for stuck keys","description":"Check for stuck keys"},{"title":"Restart your computer","description":"Restart your computer"},{"title":"Try a different USB","description":"Try a different USB port"}]
  })

  const steps = [{"title":"Check keyboard connections","description":"Check keyboard connections"},{"title":"Test keyboard on another","description":"Test keyboard on another computer"},{"title":"Update keyboard drivers","description":"Update keyboard drivers"},{"title":"Check for stuck keys","description":"Check for stuck keys"},{"title":"Restart your computer","description":"Restart your computer"},{"title":"Try a different USB","description":"Try a different USB port"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Keyboard Not Working on Chromebook', path: '/issues/keyboard-not-working-chromebook' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Keyboard Not Working on Chromebook</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Chromebook keyboard unresponsive or missing input. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "keyboard-not-working-chromebook", deviceType: "keyboard", platform: "Chromebook", title: "Keyboard Not Working on Chromebook" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Chromebook keyboard unresponsive or missing input"
              platform="Chromebook"
              deviceType="keyboard"
            />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Check keyboard connections</li>
              <li>Test keyboard on another computer</li>
              <li>Update keyboard drivers</li>
              <li>Check for stuck keys</li>
            ...
            <p className="text-gray-700 mb-4">
              Chromebook includes strict privacy controls that can block keyboard access. The system requires explicit permission for applications to use your keyboard, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Chromebook may not automatically install the correct drivers for your keyboard, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the keyboard simultaneously. Chromebook allows only one application to use the keyboard at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "Chromebook", slug: 'keyboard-not-working-chromebook' }} />
            ...
            <p className="text-gray-700 mb-4">
              Chromebook requires explicit permission for keyboard access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Chromebook settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open Chromebook settings and navigate to keyboard permissions. Enable access for your application and restart if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Chromebook may be using the wrong keyboard or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or keyboard manufacturer's website. Download the latest drivers for Chromebook and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Chromebook</h3>
            <p className="text-gray-700 mb-4">
              Chromebook has specific settings for keyboard access. Follow these detailed steps for Chromebook.
            </p>
            <p className="text-gray-700 mb-4">
              Open Chromebook settings and navigate to keyboard permissions. Enable access for your application and restart if needed.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>Check for Chromebook updates</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              Keep Chromebook updated. System updates often include driver updates that can fix keyboard issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable keyboard access in privacy settings unless necessary. Chromebook remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
