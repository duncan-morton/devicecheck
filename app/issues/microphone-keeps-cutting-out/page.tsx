...
const issuePath = '/issues/microphone-keeps-cutting-out'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Microphone Keeps Cutting Out - Complete Fix Guide',
  description: 'Fix microphone keeps cutting out. Step-by-step troubleshooting guide covering All settings, permissions, drivers, and solutions for intermittent microphone drop-outs or unstable audio.',
  path: issuePath,
  keywords: ["microphone cutting out","mic keeps disconnecting","voice dropping intermittently"]
}), alternates }

const faqs = [
  {
    "question": "Why is microphone keeps cutting out?",
    "answer": "Intermittent microphone drop-outs or unstable audio. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone keeps cutting out?",
  ...
  {
    "question": "What causes microphone keeps cutting out?",
  ...
  {
    "question": "Can I fix microphone keeps cutting out without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Keeps Cutting Out - Complete Fix Guide',
    'Fix microphone keeps cutting out. Step-by-step troubleshooting guide.',
    '/issues/microphone-keeps-cutting-out',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Microphone Keeps Cutting Out","path":"/issues/microphone-keeps-cutting-out"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-keeps-cutting-out',
    name: 'Microphone Keeps Cutting Out',
    description: 'Fix microphone keeps cutting out with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Keeps Cutting Out', path: '/issues/microphone-keeps-cutting-out' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Keeps Cutting Out</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Intermittent microphone drop-outs or unstable audio on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <IssueDiagnostic device="mic" mode="defer" />

          <IssueLinksPanel issue={{ slug: "microphone-keeps-cutting-out", deviceType: "mic", platform: "All", title: "Microphone Keeps Cutting Out" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Intermittent microphone drop-outs or unstable audio"
              platform="All"
              deviceType="mic"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "All", slug: 'microphone-keeps-cutting-out' }} />
