...
const faqs = [
  ...
  },
  {
    ...
    "answer": "First, check Firefox permissions and settings. Verify the correct camera is selected. Update drivers if needed. Use the webcam test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes webcam not working in firefox?",
  ...
  {
    "question": "Can I fix webcam not working in firefox without technical knowledge?",
    "answer": "Yes. Most camera issues can be fixed by checking permissions in Firefox settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
    "question": "How do I enable camera in Firefox?",
    "answer": "Click the lock icon in Firefox's address bar, then set Camera to \"Allow\". Go to about:preferences#privacy and scroll to Permissions. Click Settings next to Camera and ensure your site is allowed."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Not Working in Firefox - Complete Fix Guide',
    'Fix webcam not working in firefox. Step-by-step troubleshooting guide.',
    '/issues/webcam-not-working-firefox',
  ...
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-not-working-firefox',
    name: 'Webcam Not Working in Firefox',
    description: 'Fix webcam not working in firefox with clear steps for Firefox covering permissions, device selection, and drivers.',
    steps: [{"title":"Enable camera in Firefox","description":"Enable camera in Firefox settings"},{"title":"Check browser permissions","description":"Check browser permissions"},{"title":"Verify system camera access","description":"Verify system camera access"},{"title":"Clear Firefox cache","description":"Clear Firefox cache"},{"title":"Update Firefox to latest","description":"Update Firefox to latest version"}]
  })

  const steps = [{"title":"Enable camera in Firefox","description":"Enable camera in Firefox settings"},{"title":"Check browser permissions","description":"Check browser permissions"},{"title":"Verify system camera access","description":"Verify system camera access"},{"title":"Clear Firefox cache","description":"Clear Firefox cache"},{"title":"Update Firefox to latest","description":"Update Firefox to latest version"}]
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Not Working in Firefox</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Firefox blocking or not detecting webcam. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Enable camera in Firefox settings</li>
              <li>Check browser permissions</li>
              <li>Verify system camera access</li>
            ...
            <p className="text-gray-700 mb-4">
              Firefox includes strict privacy controls that can block camera access. The system requires explicit permission for applications to use your camera, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Firefox may not automatically install the correct drivers for your camera, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the camera simultaneously. Firefox allows only one application to use the camera at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "Firefox", slug: 'webcam-not-working-firefox' }} />
            ...
            <p className="text-gray-700 mb-4">
              Firefox requires explicit permission for camera access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Firefox settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Click the lock icon in Firefox's address bar, then set Camera to "Allow". Go to about:preferences#privacy and scroll to Permissions. Click Settings next to Camera and ensure your site is allowed. Verify Windows camera permissions are enabled.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Firefox may be using the wrong camera or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or camera manufacturer's website. Download the latest drivers for Firefox and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Firefox</h3>
            <p className="text-gray-700 mb-4">
              Firefox has specific settings for camera access. Follow these detailed steps for Firefox.
            </p>
            <p className="text-gray-700 mb-4">
              Click the lock icon in Firefox's address bar, then set Camera to "Allow". Go to about:preferences#privacy and scroll to Permissions. Click Settings next to Camera and ensure your site is allowed. Verify Windows camera permissions are enabled.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Firefox updated. System updates often include driver updates that can fix camera issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable camera access in privacy settings unless necessary. Firefox remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
