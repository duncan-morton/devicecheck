...
const faqs = [
  {
    "question": "Why is microphone not working on windows 11?",
    "answer": "Microphone not detected on Windows 11. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working on windows 11?",
  ...
  {
    "question": "What causes microphone not working on windows 11?",
  ...
  {
    "question": "Can I fix microphone not working on windows 11 without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    ...
    'Fix microphone not working on windows 11. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-windows-11',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Microphone Not Working on Windows 11","path":"/issues/microphone-not-working-windows-11"}]
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <IssueLinksPanel issue={{ slug: "microphone-not-working-windows-11", deviceType: "mic", platform: "Windows 11", title: "Microphone Not Working on Windows 11" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Windows 11", slug: 'microphone-not-working-windows-11' }} />
