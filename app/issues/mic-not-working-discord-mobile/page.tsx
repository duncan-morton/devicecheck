...
const faqs = [
  {
    "question": "Why is microphone not working on discord mobile?",
    "answer": "Microphone not working in Discord mobile app. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working on discord mobile?",
    "answer": "First, check Discord Mobile permissions and settings. Verify the correct microphone is selected. Update drivers if needed. Use the microphone test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes microphone not working on discord mobile?",
  ...
  {
    "question": "Can I fix microphone not working on discord mobile without technical knowledge?",
    "answer": "Yes. Most microphone issues can be fixed by checking permissions in Discord Mobile settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working on Discord Mobile - Complete Fix Guide',
    'Fix microphone not working on discord mobile. Step-by-step troubleshooting guide.',
    '/issues/mic-not-working-discord-mobile',
  ...
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/mic-not-working-discord-mobile',
    name: 'Microphone Not Working on Discord Mobile',
    description: 'Fix microphone not working on discord mobile with clear steps for Discord Mobile covering permissions, device selection, and drivers.',
    steps: [{"title":"Check Discord app permissions","description":"Check Discord app permissions"},{"title":"Enable microphone in device","description":"Enable microphone in device settings"},{"title":"Grant microphone permission to","description":"Grant microphone permission to Discord"},{"title":"Restart Discord app","description":"Restart Discord app"},{"title":"Check device microphone settings","description":"Check device microphone settings"}]
  })

  const steps = [{"title":"Check Discord app permissions","description":"Check Discord app permissions"},{"title":"Enable microphone in device","description":"Enable microphone in device settings"},{"title":"Grant microphone permission to","description":"Grant microphone permission to Discord"},{"title":"Restart Discord app","description":"Restart Discord app"},{"title":"Check device microphone settings","description":"Check device microphone settings"}]
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working on Discord Mobile</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Microphone not working in Discord mobile app. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
            This is a Discord Mobile device issue. <Link href="/hubs/discord-issues" className="text-blue-600 hover:text-blue-800 font-medium">See all Discord issues →</Link>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Check Discord app permissions</li>
              <li>Enable microphone in device settings</li>
              <li>Grant microphone permission to Discord</li>
              <li>Restart Discord app</li>
            ...
            <p className="text-gray-700 mb-4">
              Discord Mobile includes strict privacy controls that can block microphone access. The system requires explicit permission for applications to use your microphone, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Discord Mobile may not automatically install the correct drivers for your microphone, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the microphone simultaneously. Discord Mobile allows only one application to use the microphone at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Discord Mobile", slug: 'mic-not-working-discord-mobile' }} />
            ...
            <p className="text-gray-700 mb-4">
              Discord Mobile requires explicit permission for microphone access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Discord Mobile settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open your device Settings → Apps → Discord → Permissions. Enable Microphone permission. Open Discord and go to User Settings → Voice & Video. Select your microphone under Input Device. Test your microphone using the input sensitivity meter.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Discord Mobile may be using the wrong microphone or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or microphone manufacturer's website. Download the latest drivers for Discord Mobile and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Discord Mobile</h3>
            <p className="text-gray-700 mb-4">
              Discord Mobile has specific settings for microphone access. Follow these detailed steps for Discord Mobile.
            </p>
            <p className="text-gray-700 mb-4">
              Open your device Settings → Apps → Discord → Permissions. Enable Microphone permission. Open Discord and go to User Settings → Voice & Video. Select your microphone under Input Device. Test your microphone using the input sensitivity meter.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>Check for Discord Mobile updates</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              Keep Discord Mobile updated. System updates often include driver updates that can fix microphone issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable microphone access in privacy settings unless necessary. Discord Mobile remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
