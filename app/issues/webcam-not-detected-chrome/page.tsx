...
export const metadata: Metadata = genMeta({
  ...
  path: '/issues/webcam-not-detected-chrome',
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200">
            ...
            <p className="text-lg text-gray-700 mb-4">
              Camera blocked by Chrome permissions on Chrome prevents normal use of your camera. This guide covers all solutions for webcam not detected in chrome, from permissions to driver updates.
            </p>
