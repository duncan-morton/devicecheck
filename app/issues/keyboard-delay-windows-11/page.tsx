...
const issuePath = '/issues/keyboard-delay-windows-11'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Keyboard Input Delay on Windows 11 - Complete Fix Guide',
  description: 'Fix keyboard input delay on windows 11. Step-by-step troubleshooting guide covering Windows 11 settings, permissions, drivers, and solutions for typing feels delayed or sluggish.',
  path: issuePath,
  keywords: ["keyboard delay windows 11","typing lag windows","slow keyboard response windows 11"]
}), alternates }

const faqs = [
  {
    "question": "Why is keyboard input delay on windows 11?",
    "answer": "Typing feels delayed or sluggish. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix keyboard input delay on windows 11?",
  ...
  {
    "question": "What causes keyboard input delay on windows 11?",
  ...
  {
    "question": "Can I fix keyboard input delay on windows 11 without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Keyboard Input Delay on Windows 11 - Complete Fix Guide',
    'Fix keyboard input delay on windows 11. Step-by-step troubleshooting guide.',
    '/issues/keyboard-delay-windows-11',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Keyboard Input Delay on Windows 11","path":"/issues/keyboard-delay-windows-11"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-delay-windows-11',
    name: 'Keyboard Input Delay on Windows 11',
    description: 'Fix keyboard input delay on windows 11 with clear steps for Windows 11 covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Keyboard Input Delay on Windows 11', path: '/issues/keyboard-delay-windows-11' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Keyboard Input Delay on Windows 11</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Typing feels delayed or sluggish on Windows 11. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <IssueDiagnostic device="keyboard" mode="defer" />

          <IssueLinksPanel issue={{ slug: "keyboard-delay-windows-11", deviceType: "keyboard", platform: "Windows 11", title: "Keyboard Input Delay on Windows 11" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Typing feels delayed or sluggish"
              platform="Windows 11"
              deviceType="keyboard"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "Windows 11", slug: 'keyboard-delay-windows-11' }} />
