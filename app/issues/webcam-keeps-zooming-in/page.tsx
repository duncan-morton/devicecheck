...
const faqs = [
  {
    "question": "Why is webcam keeps zooming in?",
    "answer": "Auto-zoom or auto-crop enabled unexpectedly. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam keeps zooming in?",
  ...
  {
    "question": "What causes webcam keeps zooming in?",
  ...
  {
    "question": "Can I fix webcam keeps zooming in without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Keeps Zooming In - Complete Fix Guide',
    'Fix webcam keeps zooming in. Step-by-step troubleshooting guide.',
    '/issues/webcam-keeps-zooming-in',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Keeps Zooming In","path":"/issues/webcam-keeps-zooming-in"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-keeps-zooming-in',
    name: 'Webcam Keeps Zooming In',
    description: 'Fix webcam keeps zooming in with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Keeps Zooming In', path: '/issues/webcam-keeps-zooming-in' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Keeps Zooming In</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Auto-zoom or auto-crop enabled unexpectedly on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Auto-zoom or auto-crop enabled unexpectedly"
              platform="All"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-keeps-zooming-in' }} />
