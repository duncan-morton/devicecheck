...
const issuePath = '/issues/microphone-not-working-mac'
export const metadata: Metadata = { ...genMeta({
  title: 'Microphone Not Working on Mac - Complete Fix Guide',
  description: 'Fix microphone not working on mac. Step-by-step troubleshooting guide covering Mac settings, permissions, drivers, and solutions for mac cannot access microphone.',
  path: issuePath,
  keywords: ["microphone not working mac","mac mic not detected","macos microphone issues"]
}) }

const faqs = [
  {
    "question": "Why is microphone not working on mac?",
    "answer": "Mac cannot access microphone. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working on mac?",
    "answer": "First, check Mac permissions and settings. Verify the correct microphone is selected. Update drivers if needed. Use the microphone test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes microphone not working on mac?",
  ...
  {
    "question": "Can I fix microphone not working on mac without technical knowledge?",
    "answer": "Yes. Most microphone issues can be fixed by checking permissions in Mac settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working on Mac - Complete Fix Guide',
    'Fix microphone not working on mac. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-mac',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Mac device issues","path":"/hubs/mac-device-issues"},{"name":"Microphone Not Working on Mac","path":"/issues/microphone-not-working-mac"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-mac',
    name: 'Microphone Not Working on Mac',
    description: 'Fix microphone not working on mac with clear steps for Mac covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Not Working on Mac', path: '/issues/microphone-not-working-mac' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working on Mac</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Mac cannot access microphone. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
            This is a Mac device issue. <Link href="/hubs/mac-device-issues" className="text-blue-600 hover:text-blue-800 font-medium">See all Mac device issues →</Link>
          </div>


          <IssueDiagnostic device="mic" mode="defer" />

          <IssueLinksPanel issue={{ slug: "microphone-not-working-mac", deviceType: "mic", platform: "Mac", title: "Microphone Not Working on Mac" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Mac cannot access microphone"
              platform="Mac"
              deviceType="mic"
            />
            ...
            <p className="text-gray-700 mb-4">
              Mac includes strict privacy controls that can block microphone access. The system requires explicit permission for applications to use your microphone, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Mac may not automatically install the correct drivers for your microphone, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the microphone simultaneously. Mac allows only one application to use the microphone at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Mac", slug: 'microphone-not-working-mac' }} />
            ...
            <p className="text-gray-700 mb-4">
              Mac requires explicit permission for microphone access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Mac settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open Mac settings and navigate to microphone permissions. Enable access for your application and restart if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Mac may be using the wrong microphone or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or microphone manufacturer's website. Download the latest drivers for Mac and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Mac</h3>
            <p className="text-gray-700 mb-4">
              Mac has specific settings for microphone access. Follow these detailed steps for Mac.
            </p>
            <p className="text-gray-700 mb-4">
              Open Mac settings and navigate to microphone permissions. Enable access for your application and restart if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Mac updated. System updates often include driver updates that can fix microphone issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable microphone access in privacy settings unless necessary. Mac remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
