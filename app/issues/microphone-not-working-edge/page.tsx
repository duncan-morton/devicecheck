...
export default function IssuePage() {
  ...
  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Microphone Not Working in Edge","path":"/issues/microphone-not-working-edge"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-edge',
    name: 'Microphone Not Working in Edge',
    description: 'Fix microphone not working in edge with clear steps for Edge covering permissions, device selection, and drivers.',
    steps: [{"title":"Enable microphone in Edge","description":"Enable microphone in Edge settings"},{"title":"Check browser permissions","description":"Check browser permissions"},{"title":"Verify Windows microphone access","description":"Verify Windows microphone access"},{"title":"Clear Edge cache","description":"Clear Edge cache"},{"title":"Update Edge to latest","description":"Update Edge to latest version"}]
  })
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working in Edge</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Microphone not detected or not working in Microsoft Edge. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Microphone not detected or not working in Microsoft Edge"
              platform="Edge"
              deviceType="mic"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Edge", slug: 'microphone-not-working-edge' }} />
