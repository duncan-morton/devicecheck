...
const faqs = [
  {
    "question": "Why is webcam quality poor or grainy?",
    "answer": "Low resolution or bad lighting. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam quality poor or grainy?",
  ...
  {
    "question": "What causes webcam quality poor or grainy?",
  ...
  {
    "question": "Can I fix webcam quality poor or grainy without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Quality Poor or Grainy - Complete Fix Guide',
    'Fix webcam quality poor or grainy. Step-by-step troubleshooting guide.',
    '/issues/webcam-poor-quality',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Quality Poor or Grainy","path":"/issues/webcam-poor-quality"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-poor-quality',
    name: 'Webcam Quality Poor or Grainy',
    description: 'Fix webcam quality poor or grainy with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Quality Poor or Grainy', path: '/issues/webcam-poor-quality' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Quality Poor or Grainy</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Low resolution or bad lighting on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Low resolution or bad lighting"
              platform="All"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-poor-quality' }} />
