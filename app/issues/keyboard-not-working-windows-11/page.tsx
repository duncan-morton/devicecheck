...
const issuePath = '/issues/keyboard-not-working-windows-11'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Keyboard Not Working on Windows 11 - Complete Fix Guide',
  description: 'Fix keyboard not working on windows 11. Step-by-step troubleshooting guide covering Windows 11 settings, permissions, drivers, and solutions for keyboard not responding on windows 11.',
  path: issuePath,
  keywords: ["keyboard not working windows 11","windows 11 keyboard fix","keyboard not detected windows 11"]
}), alternates }

const faqs = [
  {
    "question": "Why is keyboard not working on windows 11?",
    "answer": "Keyboard not responding on Windows 11. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix keyboard not working on windows 11?",
    "answer": "First, check Windows 11 permissions and settings. Verify the correct keyboard is selected. Update drivers if needed. Use the keyboard test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes keyboard not working on windows 11?",
  ...
  {
    "question": "Can I fix keyboard not working on windows 11 without technical knowledge?",
    "answer": "Yes. Most keyboard issues can be fixed by checking permissions in Windows 11 settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
    "question": "How do I enable camera in Windows 11?",
    "answer": "Open Settings → Privacy & Security → Camera. Ensure access is turned on and \"Let desktop apps access your keyboard\" is enabled. Restart your computer after changing these settings."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Keyboard Not Working on Windows 11 - Complete Fix Guide',
    'Fix keyboard not working on windows 11. Step-by-step troubleshooting guide.',
    '/issues/keyboard-not-working-windows-11',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Keyboard Not Working on Windows 11","path":"/issues/keyboard-not-working-windows-11"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-not-working-windows-11',
    name: 'Keyboard Not Working on Windows 11',
    description: 'Fix keyboard not working on windows 11 with clear steps for Windows 11 covering permissions, device selection, and drivers.',
    steps: [{"title":"Check keyboard language settings","description":"Check keyboard language settings in Settings"},{"title":"Verify keyboard layout is","description":"Verify keyboard layout is correct"},{"title":"Update keyboard drivers through","description":"Update keyboard drivers through Device Manager"},{"title":"Check for Windows 11","description":"Check for Windows 11 updates"},{"title":"Run keyboard troubleshooter","description":"Run keyboard troubleshooter"}]
  })

  const steps = [{"title":"Check keyboard language settings","description":"Check keyboard language settings in Settings"},{"title":"Verify keyboard layout is","description":"Verify keyboard layout is correct"},{"title":"Update keyboard drivers through","description":"Update keyboard drivers through Device Manager"},{"title":"Check for Windows 11","description":"Check for Windows 11 updates"},{"title":"Run keyboard troubleshooter","description":"Run keyboard troubleshooter"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Keyboard Not Working on Windows 11', path: '/issues/keyboard-not-working-windows-11' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Keyboard Not Working on Windows 11</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Keyboard not responding on Windows 11. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "keyboard-not-working-windows-11", deviceType: "keyboard", platform: "Windows 11", title: "Keyboard Not Working on Windows 11" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Keyboard not responding on Windows 11"
              platform="Windows 11"
              deviceType="keyboard"
            />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Check keyboard language settings in Settings</li>
              <li>Verify keyboard layout is correct</li>
              <li>Update keyboard drivers through Device Manager</li>
              <li>Check for Windows 11 updates</li>
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 includes strict privacy controls that can block keyboard access. The system requires explicit permission for applications to use your keyboard, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Windows 11 may not automatically install the correct drivers for your keyboard, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the keyboard simultaneously. Windows 11 allows only one application to use the keyboard at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "Windows 11", slug: 'keyboard-not-working-windows-11' }} />
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 requires explicit permission for keyboard access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Windows 11 settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open Settings → Time & Language → Language & Region. Verify keyboard layout. Go to Settings → Devices → Typing and check keyboard settings. Open Device Manager and update keyboard drivers if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Windows 11 may be using the wrong keyboard or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or keyboard manufacturer's website. Download the latest drivers for Windows 11 and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Windows 11</h3>
            <p className="text-gray-700 mb-4">
              Windows 11 has specific settings for keyboard access. Follow these detailed steps for Windows 11.
            </p>
            <p className="text-gray-700 mb-4">
              Open Settings → Time & Language → Language & Region. Verify keyboard layout. Go to Settings → Devices → Typing and check keyboard settings. Open Device Manager and update keyboard drivers if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Windows 11 updated. System updates often include driver updates that can fix keyboard issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable keyboard access in privacy settings unless necessary. Windows 11 remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
          ...
          {
                    "title": "Keyboard Typing Wrong Characters on Windows",
                    "href": "/issues/keyboard-typing-wrong-characters-windows"
          },
          {
