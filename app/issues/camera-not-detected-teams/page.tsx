...
const issuePath = '/issues/camera-not-detected-teams'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Camera Not Detected in Teams - Complete Fix Guide',
  description: 'Fix camera not detected in teams. Step-by-step troubleshooting guide covering Microsoft Teams settings, permissions, drivers, and solutions for camera not showing or detected in microsoft teams.',
  path: issuePath,
  keywords: ["camera not detected teams","teams webcam not working","microsoft teams camera fix","teams camera not showing","webcam not working teams"]
}), alternates }

const faqs = [
  {
    "question": "Why is camera not detected in teams?",
    "answer": "Camera not showing or detected in Microsoft Teams. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix camera not detected in teams?",
    "answer": "First, check Microsoft Teams permissions and settings. Verify the correct camera is selected. Update drivers if needed. Use the webcam test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes camera not detected in teams?",
  ...
  {
    "question": "Can I fix camera not detected in teams without technical knowledge?",
    "answer": "Yes. Most camera issues can be fixed by checking permissions in Microsoft Teams settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Camera Not Detected in Teams - Complete Fix Guide',
    'Fix camera not detected in teams. Step-by-step troubleshooting guide.',
    '/issues/camera-not-detected-teams',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Teams issues","path":"/hubs/teams-issues"},{"name":"Camera Not Detected in Teams","path":"/issues/camera-not-detected-teams"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/camera-not-detected-teams',
    name: 'Camera Not Detected in Teams',
    description: 'Fix camera not detected in teams with clear steps for Microsoft Teams covering permissions, device selection, and drivers.',
    steps: [{"title":"Check Teams camera settings","description":"Check Teams camera settings"},{"title":"Verify Windows camera permissions","description":"Verify Windows camera permissions"},{"title":"Select correct camera in","description":"Select correct camera in Teams"},{"title":"Test camera in Teams","description":"Test camera in Teams settings"},{"title":"Restart Teams application","description":"Restart Teams application"}]
  })

  const steps = [{"title":"Check Teams camera settings","description":"Check Teams camera settings"},{"title":"Verify Windows camera permissions","description":"Verify Windows camera permissions"},{"title":"Select correct camera in","description":"Select correct camera in Teams"},{"title":"Test camera in Teams","description":"Test camera in Teams settings"},{"title":"Restart Teams application","description":"Restart Teams application"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Camera Not Detected in Teams', path: '/issues/camera-not-detected-teams' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Camera Not Detected in Teams</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Camera not showing or detected in Microsoft Teams. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
            This is a Microsoft Teams device issue. <Link href="/hubs/teams-issues" className="text-blue-600 hover:text-blue-800 font-medium">See all Teams issues →</Link>
          </div>


          <IssueDiagnostic device="webcam" mode="defer" />

          <IssueLinksPanel issue={{ slug: "camera-not-detected-teams", deviceType: "webcam", platform: "Microsoft Teams", title: "Camera Not Detected in Teams" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Check Teams camera settings</li>
              <li>Verify Windows camera permissions</li>
              <li>Select correct camera in Teams</li>
              <li>Test camera in Teams settings</li>
            ...
            <p className="text-gray-700 mb-4">
              Microsoft Teams includes strict privacy controls that can block camera access. The system requires explicit permission for applications to use your camera, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Microsoft Teams may not automatically install the correct drivers for your camera, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the camera simultaneously. Microsoft Teams allows only one application to use the camera at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "Microsoft Teams", slug: 'camera-not-detected-teams' }} />
            ...
            <p className="text-gray-700 mb-4">
              Microsoft Teams requires explicit permission for camera access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Microsoft Teams settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open Teams → Settings → Devices. Under Camera, select your device from the dropdown. Click "Test video" to verify it works. If not detected, check Windows Settings → Privacy & Security → Camera and ensure Teams has permission.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Microsoft Teams may be using the wrong camera or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or camera manufacturer's website. Download the latest drivers for Microsoft Teams and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Microsoft Teams has specific settings for camera access. Follow these detailed steps for Microsoft Teams.
            </p>
            <p className="text-gray-700 mb-4">
              Open Teams → Settings → Devices. Under Camera, select your device from the dropdown. Click "Test video" to verify it works. If not detected, check Windows Settings → Privacy & Security → Camera and ensure Teams has permission.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>Check for Microsoft Teams updates</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              Keep Microsoft Teams updated. System updates often include driver updates that can fix camera issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable camera access in privacy settings unless necessary. Microsoft Teams remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
