...
export const metadata: Metadata = { ...genMeta({
  ...
  description: 'Fix microphone not working in zoom. Step-by-step troubleshooting guide covering Zoom settings, permissions, drivers, and solutions for microphone not detected or no audio in zoom.',
  path: issuePath,
  keywords: ["microphone not working zoom","zoom mic fix","zoom microphone not detected","zoom audio not working","zoom microphone settings"]
}) }

const faqs = [
  {
    "question": "Why is microphone not working in zoom?",
    "answer": "Microphone not detected or no audio in Zoom. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working in zoom?",
  ...
  {
    "question": "What causes microphone not working in zoom?",
  ...
  {
    "question": "Can I fix microphone not working in zoom without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working in Zoom - Complete Fix Guide',
    'Fix microphone not working in zoom. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-zoom',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Zoom issues","path":"/hubs/zoom-issues"},{"name":"Microphone Not Working in Zoom","path":"/issues/microphone-not-working-zoom"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-zoom',
    name: 'Microphone Not Working in Zoom',
    description: 'Fix microphone not working in zoom with clear steps for Zoom covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Not Working in Zoom', path: '/issues/microphone-not-working-zoom' }
          ]} />
          ...
          <IssueLinksPanel issue={{ slug: "microphone-not-working-zoom", deviceType: "mic", platform: "Zoom", title: "Microphone Not Working in Zoom" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Microphone not detected or no audio in Zoom"
              platform="Zoom"
              deviceType="mic"
            />
