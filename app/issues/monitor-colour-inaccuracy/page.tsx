...
const issuePath = '/issues/monitor-colour-inaccuracy'
export const metadata: Metadata = { ...genMeta({
  title: 'Monitor Colour Inaccuracy Issues - Complete Fix Guide',
  description: 'Fix monitor colour inaccuracy issues. Step-by-step troubleshooting guide covering All settings, permissions, drivers, and solutions for incorrect or washed-out colours.',
  path: issuePath,
  keywords: ["monitor colour inaccuracy","monitor colours wrong","colour calibration fix"]
}) }

const faqs = [
  {
    "question": "Why is monitor colour inaccuracy issues?",
    "answer": "Incorrect or washed-out colours. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix monitor colour inaccuracy issues?",
  ...
  {
    "question": "What causes monitor colour inaccuracy issues?",
  ...
  {
    "question": "Can I fix monitor colour inaccuracy issues without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Monitor Colour Inaccuracy Issues - Complete Fix Guide',
    'Fix monitor colour inaccuracy issues. Step-by-step troubleshooting guide.',
    '/issues/monitor-colour-inaccuracy',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Monitor Colour Inaccuracy Issues","path":"/issues/monitor-colour-inaccuracy"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/monitor-colour-inaccuracy',
    name: 'Monitor Colour Inaccuracy Issues',
    description: 'Fix monitor colour inaccuracy issues with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Monitor Colour Inaccuracy Issues', path: '/issues/monitor-colour-inaccuracy' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Monitor Colour Inaccuracy Issues</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Incorrect or washed-out colours on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Incorrect or washed-out colours"
              platform="All"
              deviceType="screen"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'screen', platform: "All", slug: 'monitor-colour-inaccuracy' }} />
