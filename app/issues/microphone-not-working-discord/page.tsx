...
const issuePath = '/issues/microphone-not-working-discord'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Microphone Not Working in Discord - Complete Fix Guide',
  description: 'Fix microphone not working in discord. Step-by-step troubleshooting guide covering Discord settings, permissions, drivers, and solutions for discord not receiving audio.',
  path: issuePath,
  keywords: ["microphone not working discord","discord mic fix","discord no input detected"]
}), alternates }

const faqs = [
  {
    "question": "Why is microphone not working in discord?",
    "answer": "Discord not receiving audio. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working in discord?",
  ...
  {
    "question": "What causes microphone not working in discord?",
  ...
  {
    "question": "Can I fix microphone not working in discord without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working in Discord - Complete Fix Guide',
    'Fix microphone not working in discord. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-discord',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Discord issues","path":"/hubs/discord-issues"},{"name":"Microphone Not Working in Discord","path":"/issues/microphone-not-working-discord"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-discord',
    name: 'Microphone Not Working in Discord',
    description: 'Fix microphone not working in discord with clear steps for Discord covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Not Working in Discord', path: '/issues/microphone-not-working-discord' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working in Discord</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Discord not receiving audio. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "microphone-not-working-discord", deviceType: "mic", platform: "Discord", title: "Microphone Not Working in Discord" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Discord not receiving audio"
              platform="Discord"
              deviceType="mic"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Discord", slug: 'microphone-not-working-discord' }} />
