...
const faqs = [
  {
    "question": "Why is keyboard shortcuts not working?",
    "answer": "Hotkeys or shortcuts no longer respond. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix keyboard shortcuts not working?",
  ...
  {
    "question": "What causes keyboard shortcuts not working?",
  ...
  {
    "question": "Can I fix keyboard shortcuts not working without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Keyboard Shortcuts Not Working - Complete Fix Guide',
    'Fix keyboard shortcuts not working. Step-by-step troubleshooting guide.',
    '/issues/keyboard-shortcuts-not-working',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Keyboard Shortcuts Not Working","path":"/issues/keyboard-shortcuts-not-working"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-shortcuts-not-working',
    name: 'Keyboard Shortcuts Not Working',
    description: 'Fix keyboard shortcuts not working with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Keyboard Shortcuts Not Working', path: '/issues/keyboard-shortcuts-not-working' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Keyboard Shortcuts Not Working</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Hotkeys or shortcuts no longer respond on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Hotkeys or shortcuts no longer respond"
              platform="All"
              deviceType="keyboard"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "All", slug: 'keyboard-shortcuts-not-working' }} />
