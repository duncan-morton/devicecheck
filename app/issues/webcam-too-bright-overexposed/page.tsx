...
const faqs = [
  {
    "question": "Why is webcam too bright or overexposed?",
    "answer": "Webcam image appears too bright or washed out. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam too bright or overexposed?",
  ...
  {
    "question": "What causes webcam too bright or overexposed?",
  ...
  {
    "question": "Can I fix webcam too bright or overexposed without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Too Bright or Overexposed - Complete Fix Guide',
    'Fix webcam too bright or overexposed. Step-by-step troubleshooting guide.',
    '/issues/webcam-too-bright-overexposed',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Too Bright or Overexposed","path":"/issues/webcam-too-bright-overexposed"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-too-bright-overexposed',
    name: 'Webcam Too Bright or Overexposed',
    description: 'Fix webcam too bright or overexposed with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Too Bright or Overexposed', path: '/issues/webcam-too-bright-overexposed' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Too Bright or Overexposed</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Webcam image appears too bright or washed out on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Webcam image appears too bright or washed out"
              platform="All"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-too-bright-overexposed' }} />
