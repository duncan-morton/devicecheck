...
const issuePath = '/issues/bluetooth-microphone-not-working'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Bluetooth Microphone Not Working - Complete Fix Guide',
  description: 'Fix bluetooth microphone not working. Step-by-step troubleshooting guide covering Bluetooth settings, permissions, drivers, and solutions for bluetooth microphone pairing or input issues.',
  path: issuePath,
  keywords: ["bluetooth microphone not working","bluetooth mic pairing fix","wireless mic not detected"]
}), alternates }

const faqs = [
  {
    "question": "Why is bluetooth microphone not working?",
    "answer": "Bluetooth microphone pairing or input issues. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix bluetooth microphone not working?",
    "answer": "First, check Bluetooth permissions and settings. Verify the correct microphone is selected. Update drivers if needed. Use the microphone test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes bluetooth microphone not working?",
  ...
  {
    "question": "Can I fix bluetooth microphone not working without technical knowledge?",
    "answer": "Yes. Most microphone issues can be fixed by checking permissions in Bluetooth settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Bluetooth Microphone Not Working - Complete Fix Guide',
    'Fix bluetooth microphone not working. Step-by-step troubleshooting guide.',
    '/issues/bluetooth-microphone-not-working',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Bluetooth Microphone Not Working","path":"/issues/bluetooth-microphone-not-working"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/bluetooth-microphone-not-working',
    name: 'Bluetooth Microphone Not Working',
    description: 'Fix bluetooth microphone not working with clear steps for Bluetooth covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Bluetooth Microphone Not Working', path: '/issues/bluetooth-microphone-not-working' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Bluetooth Microphone Not Working</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Bluetooth microphone pairing or input issues. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Bluetooth microphone pairing or input issues"
              platform="Bluetooth"
              deviceType="mic"
            />
            ...
            <p className="text-gray-700 mb-4">
              Bluetooth includes strict privacy controls that can block microphone access. The system requires explicit permission for applications to use your microphone, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Bluetooth may not automatically install the correct drivers for your microphone, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the microphone simultaneously. Bluetooth allows only one application to use the microphone at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Bluetooth", slug: 'bluetooth-microphone-not-working' }} />
            ...
            <p className="text-gray-700 mb-4">
              Bluetooth requires explicit permission for microphone access. Verify permissions are enabled in system settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Bluetooth settings or preferences</li>
            ...
            <p className="text-gray-700 mb-6">
              Open Bluetooth settings and navigate to microphone permissions. Enable access for your application and restart if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Bluetooth may be using the wrong microphone or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or microphone manufacturer's website. Download the latest drivers for Bluetooth and install them manually.
            </p>
            ...
            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Bluetooth</h3>
            <p className="text-gray-700 mb-4">
              Bluetooth has specific settings for microphone access. Follow these detailed steps for Bluetooth.
            </p>
            <p className="text-gray-700 mb-4">
              Open Bluetooth settings and navigate to microphone permissions. Enable access for your application and restart if needed.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>Check for Bluetooth updates</li>
            </ul>
            ...
            <p className="text-gray-700 mb-4">
              Keep Bluetooth updated. System updates often include driver updates that can fix microphone issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable microphone access in privacy settings unless necessary. Bluetooth remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
