...
const issuePath = '/issues/webcam-not-available-other-apps'
const alternates = {
...
export const metadata: Metadata = { ...genMeta({
  title: 'Webcam Not Available to Other Apps - Complete Fix Guide',
  description: 'Fix webcam not available to other apps. Step-by-step troubleshooting guide covering All settings, permissions, drivers, and solutions for webcam locked by a background process.',
  path: issuePath,
  keywords: ["webcam not available","camera in use background","app using webcam secretly"]
}), alternates }

const faqs = [
  {
    "question": "Why is webcam not available to other apps?",
    "answer": "Webcam locked by a background process. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam not available to other apps?",
    "answer": "First, check All permissions and settings. Verify the correct camera is selected. Update drivers if needed. Use the webcam test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes webcam not available to other apps?",
  ...
  {
    "question": "Can I fix webcam not available to other apps without technical knowledge?",
    "answer": "Yes. Most camera issues can be fixed by checking permissions in All settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Not Available to Other Apps - Complete Fix Guide',
    'Fix webcam not available to other apps. Step-by-step troubleshooting guide.',
    '/issues/webcam-not-available-other-apps',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Not Available to Other Apps","path":"/issues/webcam-not-available-other-apps"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-not-available-other-apps',
    name: 'Webcam Not Available to Other Apps',
    description: 'Fix webcam not available to other apps with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Not Available to Other Apps', path: '/issues/webcam-not-available-other-apps' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Not Available to Other Apps</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Webcam locked by a background process on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "webcam-not-available-other-apps", deviceType: "webcam", platform: "All", title: "Webcam Not Available to Other Apps" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Webcam locked by a background process"
              platform="All"
              deviceType="webcam"
            />
            ...
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. All may not automatically install the correct drivers for your camera, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the camera simultaneously. All allows only one application to use the camera at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-not-available-other-apps' }} />
            ...
            <p className="text-gray-700 mb-4">
              All requires explicit permission for camera access. Verify permissions are enabled in system settings.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              Open All settings and navigate to camera permissions. Enable access for your application and restart if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              All may be using the wrong camera or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or camera manufacturer's website. Download the latest drivers for All and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              All has specific settings for camera access. Follow these detailed steps for All.
            </p>
            <p className="text-gray-700 mb-4">
              Open All settings and navigate to camera permissions. Enable access for your application and restart if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep All updated. System updates often include driver updates that can fix camera issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable camera access in privacy settings unless necessary. All remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
