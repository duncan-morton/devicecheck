...
const faqs = [
  {
    "question": "Why is keyboard not working on mac?",
    "answer": "Keyboard not responding or keys not registering on Mac. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix keyboard not working on mac?",
    "answer": "First, check macOS permissions and settings. Verify the correct keyboard is selected. Update drivers if needed. Use the keyboard test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes keyboard not working on mac?",
  ...
  {
    "question": "Can I fix keyboard not working on mac without technical knowledge?",
    "answer": "Yes. Most keyboard issues can be fixed by checking permissions in macOS settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Keyboard Not Working on Mac - Complete Fix Guide',
    'Fix keyboard not working on mac. Step-by-step troubleshooting guide.',
    '/issues/keyboard-not-working-mac',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Mac device issues","path":"/hubs/mac-device-issues"},{"name":"Keyboard Not Working on Mac","path":"/issues/keyboard-not-working-mac"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/keyboard-not-working-mac',
    name: 'Keyboard Not Working on Mac',
    description: 'Fix keyboard not working on mac with clear steps for macOS covering permissions, device selection, and drivers.',
    steps: [{"title":"Check keyboard settings in","description":"Check keyboard settings in System Preferences"},{"title":"Verify keyboard layout","description":"Verify keyboard layout"},{"title":"Reset keyboard preferences","description":"Reset keyboard preferences"},{"title":"Check for macOS updates","description":"Check for macOS updates"},{"title":"Test keyboard in different","description":"Test keyboard in different apps"}]
  })

  const steps = [{"title":"Check keyboard settings in","description":"Check keyboard settings in System Preferences"},{"title":"Verify keyboard layout","description":"Verify keyboard layout"},{"title":"Reset keyboard preferences","description":"Reset keyboard preferences"},{"title":"Check for macOS updates","description":"Check for macOS updates"},{"title":"Test keyboard in different","description":"Test keyboard in different apps"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Keyboard Not Working on Mac', path: '/issues/keyboard-not-working-mac' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Keyboard Not Working on Mac</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Keyboard not responding or keys not registering on Mac on macOS. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
            This is a macOS device issue. <Link href="/hubs/mac-device-issues" className="text-blue-600 hover:text-blue-800 font-medium">See all Mac device issues →</Link>
          </div>


          <IssueDiagnostic device="keyboard" mode="defer" />

          <IssueLinksPanel issue={{ slug: "keyboard-not-working-mac", deviceType: "keyboard", platform: "macOS", title: "Keyboard Not Working on Mac" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Keyboard not responding or keys not registering on Mac"
              platform="macOS"
              deviceType="keyboard"
            />
            ...
            <p className="text-gray-700 mb-4">
              macOS includes strict privacy controls that can block keyboard access. The system requires explicit permission for applications to use your keyboard, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. macOS may not automatically install the correct drivers for your keyboard, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the keyboard simultaneously. macOS allows only one application to use the keyboard at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'keyboard', platform: "macOS", slug: 'keyboard-not-working-mac' }} />
            ...
            <p className="text-gray-700 mb-4">
              macOS requires explicit permission for keyboard access. Verify permissions are enabled in system settings.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              Open System Preferences → Keyboard. Check Input Sources and verify your keyboard layout. Go to System Preferences → Accessibility → Keyboard and check for any enabled features that might interfere. Reset keyboard preferences if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              macOS may be using the wrong keyboard or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or keyboard manufacturer's website. Download the latest drivers for macOS and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              macOS has specific settings for keyboard access. Follow these detailed steps for macOS.
            </p>
            <p className="text-gray-700 mb-4">
              Open System Preferences → Keyboard. Check Input Sources and verify your keyboard layout. Go to System Preferences → Accessibility → Keyboard and check for any enabled features that might interfere. Reset keyboard preferences if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep macOS updated. System updates often include driver updates that can fix keyboard issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable keyboard access in privacy settings unless necessary. macOS remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
