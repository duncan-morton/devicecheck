...
const issuePath = '/issues/webcam-not-working-windows-11'
export const metadata: Metadata = { ...genMeta({
  title: 'Webcam Not Working on Windows 11 - Complete Fix Guide',
  description: 'Fix webcam not working on windows 11. Step-by-step troubleshooting guide covering Windows 11 settings, permissions, drivers, and solutions for webcam not detected or not working on windows 11.',
  path: issuePath,
  keywords: ["webcam not working windows 11","windows 11 camera fix","camera not detected windows 11","webcam not working windows","windows 11 webcam troubleshooting"]
}) }

const faqs = [
  {
    "question": "Why is webcam not working on windows 11?",
    "answer": "Webcam not detected or not working on Windows 11. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam not working on windows 11?",
    "answer": "First, check Windows 11 permissions and settings. Verify the correct camera is selected. Update drivers if needed. Use the webcam test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes webcam not working on windows 11?",
  ...
  {
    "question": "Can I fix webcam not working on windows 11 without technical knowledge?",
    "answer": "Yes. Most camera issues can be fixed by checking permissions in Windows 11 settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
    "question": "How do I enable camera in Windows 11?",
    "answer": "Open Settings → Privacy & Security → Camera. Ensure access is turned on and \"Let desktop apps access your camera\" is enabled. Restart your computer after changing these settings."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Not Working on Windows 11 - Complete Fix Guide',
    'Fix webcam not working on windows 11. Step-by-step troubleshooting guide.',
    '/issues/webcam-not-working-windows-11',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Webcam Not Working on Windows 11","path":"/issues/webcam-not-working-windows-11"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-not-working-windows-11',
    name: 'Webcam Not Working on Windows 11',
    description: 'Fix webcam not working on windows 11 with clear steps for Windows 11 covering permissions, device selection, and drivers.',
    steps: [{"title":"Enable camera in Windows","description":"Enable camera in Windows 11 Privacy settings"},{"title":"Check camera permissions","description":"Check camera permissions"},{"title":"Update camera drivers","description":"Update camera drivers"},{"title":"Verify camera is not","description":"Verify camera is not disabled"},{"title":"Run Windows troubleshooter","description":"Run Windows troubleshooter"}]
  })

  const steps = [{"title":"Enable camera in Windows","description":"Enable camera in Windows 11 Privacy settings"},{"title":"Check camera permissions","description":"Check camera permissions"},{"title":"Update camera drivers","description":"Update camera drivers"},{"title":"Verify camera is not","description":"Verify camera is not disabled"},{"title":"Run Windows troubleshooter","description":"Run Windows troubleshooter"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Not Working on Windows 11', path: '/issues/webcam-not-working-windows-11' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Not Working on Windows 11</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Webcam not detected or not working on Windows 11. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Webcam not detected or not working on Windows 11"
              platform="Windows 11"
              deviceType="webcam"
            />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Enable camera in Windows 11 Privacy settings</li>
              <li>Check camera permissions</li>
              <li>Update camera drivers</li>
              <li>Verify camera is not disabled</li>
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 includes strict privacy controls that can block camera access. The system requires explicit permission for applications to use your camera, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Windows 11 may not automatically install the correct drivers for your camera, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the camera simultaneously. Windows 11 allows only one application to use the camera at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "Windows 11", slug: 'webcam-not-working-windows-11' }} />
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 requires explicit permission for camera access. Verify permissions are enabled in system settings.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              Press Windows key + I → Privacy & Security → Camera. Turn on "Camera access" and "Let desktop apps access your camera". Scroll down and ensure your application is listed and enabled. Restart your computer after changing these settings.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Windows 11 may be using the wrong camera or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or camera manufacturer's website. Download the latest drivers for Windows 11 and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Windows 11 has specific settings for camera access. Follow these detailed steps for Windows 11.
            </p>
            <p className="text-gray-700 mb-4">
              Press Windows key + I → Privacy & Security → Camera. Turn on "Camera access" and "Let desktop apps access your camera". Scroll down and ensure your application is listed and enabled. Restart your computer after changing these settings.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Windows 11 updated. System updates often include driver updates that can fix camera issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable camera access in privacy settings unless necessary. Windows 11 remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
          ...
          },
          {
                    ...
                    "href": "/issues/webcam-not-working-zoom"
          }
]} />
