...
const faqs = [
  {
    "question": "Why is webcam not working in google meet?",
    "answer": "Webcam not showing or detected in Google Meet. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam not working in google meet?",
    "answer": "First, check Google Meet permissions and settings. Verify the correct camera is selected. Update drivers if needed. Use the webcam test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes webcam not working in google meet?",
  ...
  {
    "question": "Can I fix webcam not working in google meet without technical knowledge?",
    "answer": "Yes. Most camera issues can be fixed by checking permissions in Google Meet settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Not Working in Google Meet - Complete Fix Guide',
    'Fix webcam not working in google meet. Step-by-step troubleshooting guide.',
    '/issues/webcam-not-working-google-meet',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Not Working in Google Meet","path":"/issues/webcam-not-working-google-meet"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-not-working-google-meet',
    name: 'Webcam Not Working in Google Meet',
    description: 'Fix webcam not working in google meet with clear steps for Google Meet covering permissions, device selection, and drivers.',
    steps: [{"title":"Check Google Meet camera","description":"Check Google Meet camera settings"},{"title":"Verify browser camera permissions","description":"Verify browser camera permissions"},{"title":"Select correct camera in","description":"Select correct camera in Google Meet"},{"title":"Test camera in browser","description":"Test camera in browser"},{"title":"Update browser to latest","description":"Update browser to latest version"}]
  })

  const steps = [{"title":"Check Google Meet camera","description":"Check Google Meet camera settings"},{"title":"Verify browser camera permissions","description":"Verify browser camera permissions"},{"title":"Select correct camera in","description":"Select correct camera in Google Meet"},{"title":"Test camera in browser","description":"Test camera in browser"},{"title":"Update browser to latest","description":"Update browser to latest version"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Not Working in Google Meet', path: '/issues/webcam-not-working-google-meet' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Not Working in Google Meet</h1>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Webcam not showing or detected in Google Meet"
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Check Google Meet camera settings</li>
              <li>Verify browser camera permissions</li>
              <li>Select correct camera in Google Meet</li>
              <li>Test camera in browser</li>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "Google Meet", slug: 'webcam-not-working-google-meet' }} />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
              <li>Open Google Meet settings or preferences</li>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>Check for Google Meet updates</li>
            </ul>
