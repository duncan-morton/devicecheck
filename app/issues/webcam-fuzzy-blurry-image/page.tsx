...
const issuePath = '/issues/webcam-fuzzy-blurry-image'
export const metadata: Metadata = { ...genMeta({
  title: 'Webcam Fuzzy or Blurry Image - Complete Fix Guide',
  description: 'Fix webcam fuzzy or blurry image. Step-by-step troubleshooting guide covering All settings, permissions, drivers, and solutions for image appears unfocused or low quality.',
  path: issuePath,
  keywords: ["webcam blurry image","fuzzy webcam fix","webcam not focused"]
}) }

const faqs = [
  {
    "question": "Why is webcam fuzzy or blurry image?",
    "answer": "Image appears unfocused or low quality. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix webcam fuzzy or blurry image?",
  ...
  {
    "question": "What causes webcam fuzzy or blurry image?",
  ...
  {
    "question": "Can I fix webcam fuzzy or blurry image without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Webcam Fuzzy or Blurry Image - Complete Fix Guide',
    'Fix webcam fuzzy or blurry image. Step-by-step troubleshooting guide.',
    '/issues/webcam-fuzzy-blurry-image',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Webcam Fuzzy or Blurry Image","path":"/issues/webcam-fuzzy-blurry-image"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-fuzzy-blurry-image',
    name: 'Webcam Fuzzy or Blurry Image',
    description: 'Fix webcam fuzzy or blurry image with clear steps for All covering permissions, device selection, and drivers.',
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Webcam Fuzzy or Blurry Image', path: '/issues/webcam-fuzzy-blurry-image' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Fuzzy or Blurry Image</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Image appears unfocused or low quality on All. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Image appears unfocused or low quality"
              platform="All"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "All", slug: 'webcam-fuzzy-blurry-image' }} />
