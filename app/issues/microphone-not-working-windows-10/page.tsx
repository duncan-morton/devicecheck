...
const faqs = [
  {
    "question": "Why is microphone not working on windows 10?",
    "answer": "Microphone not detected or silent on Windows 10. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix microphone not working on windows 10?",
    "answer": "First, check Windows 10 permissions and settings. Verify the correct microphone is selected. Update drivers if needed. Use the microphone test to verify the device is working correctly. Follow the step-by-step guide above for detailed instructions."
  },
  {
  ...
  {
    "question": "What causes microphone not working on windows 10?",
  ...
  {
    "question": "Can I fix microphone not working on windows 10 without technical knowledge?",
    "answer": "Yes. Most microphone issues can be fixed by checking permissions in Windows 10 settings and ensuring the correct device is selected. Follow the step-by-step guide above for detailed instructions."
  },
  {
    "question": "How do I enable microphone in Windows 10?",
    "answer": "Open Settings → Privacy → Microphone. Turn on \"Allow apps to access your microphone\" and \"Allow desktop apps to access your microphone\". Ensure your application is listed and enabled."
  }
]

export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Working on Windows 10 - Complete Fix Guide',
    'Fix microphone not working on windows 10. Step-by-step troubleshooting guide.',
    '/issues/microphone-not-working-windows-10',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Microphone Not Working on Windows 10","path":"/issues/microphone-not-working-windows-10"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/microphone-not-working-windows-10',
    name: 'Microphone Not Working on Windows 10',
    description: 'Fix microphone not working on windows 10 with clear steps for Windows 10 covering permissions, device selection, and drivers.',
    steps: [{"title":"Enable microphone in Windows","description":"Enable microphone in Windows 10 Privacy settings"},{"title":"Verify microphone is selected","description":"Verify microphone is selected in Sound settings"},{"title":"Update audio drivers","description":"Update audio drivers"},{"title":"Close conflicting applications","description":"Close conflicting applications"},{"title":"Restart your computer","description":"Restart your computer"}]
  })
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <Breadcrumbs items={[
            ...
            { name: 'Microphone Not Working on Windows 10', path: '/issues/microphone-not-working-windows-10' }
          ]} />
          
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Microphone Not Working on Windows 10</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Microphone not detected or silent on Windows 10. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>

          <div className="mb-4 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700">
            This is a Windows 10 device issue. <Link href="/hubs/windows-device-issues" className="text-blue-600 hover:text-blue-800 font-medium">See all Windows device issues →</Link>
          </div>


          <IssueDiagnostic device="mic" mode="defer" />

          <IssueLinksPanel issue={{ slug: "microphone-not-working-windows-10", deviceType: "mic", platform: "Windows 10", title: "Microphone Not Working on Windows 10" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Microphone not detected or silent on Windows 10"
              platform="Windows 10"
              deviceType="mic"
            />
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Enable microphone in Windows 10 Privacy settings</li>
              <li>Verify microphone is selected in Sound settings</li>
              <li>Update audio drivers</li>
              <li>Close conflicting applications</li>
            ...
            <p className="text-gray-700 mb-4">
              Windows 10 includes strict privacy controls that can block microphone access. The system requires explicit permission for applications to use your microphone, and these settings can be reset after updates or changed accidentally.
            </p>
            <p className="text-gray-700 mb-4">
              Driver issues are another common cause. Windows 10 may not automatically install the correct drivers for your microphone, especially for USB devices or specialized equipment. Outdated drivers can cause detection problems or poor performance.
            </p>
            <p className="text-gray-700 mb-4">
              System conflicts occur when multiple applications try to access the microphone simultaneously. Windows 10 allows only one application to use the microphone at a time, so background apps or previous sessions can block access.
            </p>
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'mic', platform: "Windows 10", slug: 'microphone-not-working-windows-10' }} />
            ...
            <p className="text-gray-700 mb-4">
              Windows 10 requires explicit permission for microphone access. Verify permissions are enabled in system settings.
            </p>
            ...
            <p className="text-gray-700 mb-6">
              Open Settings → Privacy → Microphone. Turn on "Allow apps to access your microphone" and "Allow desktop apps to access your microphone". Ensure your application is listed and enabled. Restart your computer if needed.
            </p>

            <h3 className="text-xl font-bold text-gray-900 mt-6 mb-3">Step 2: Verify Device Selection</h3>
            <p className="text-gray-700 mb-4">
              Windows 10 may be using the wrong microphone or no device at all. Verify the correct device is selected.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-4">
            ...
            <p className="text-gray-700 mb-6">
              If automatic search doesn't find drivers, visit your computer or microphone manufacturer's website. Download the latest drivers for Windows 10 and install them manually.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Windows 10 has specific settings for microphone access. Follow these detailed steps for Windows 10.
            </p>
            <p className="text-gray-700 mb-4">
              Open Settings → Privacy → Microphone. Turn on "Allow apps to access your microphone" and "Allow desktop apps to access your microphone". Ensure your application is listed and enabled. Restart your computer if needed.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Keep Windows 10 updated. System updates often include driver updates that can fix microphone issues.
            </p>
            <p className="text-gray-700 mb-4">
              Don't disable microphone access in privacy settings unless necessary. Windows 10 remembers your choice and may block access to new applications.
            </p>
            <p className="text-gray-700 mb-4">
