...
const issuePath = '/issues/webcam-not-working-windows-10'
...
export default function IssuePage() {
  ...
  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Webcam Not Working on Windows 10","path":"/issues/webcam-not-working-windows-10"}]
  const breadcrumbs = generateBreadcrumbListSchema(breadcrumbItems)

  const faqSchema = generateFAQPageSchema(faqs)
  const howToSchema = generateHowToSchema({
    url: 'https://devicecheck.io/issues/webcam-not-working-windows-10',
    name: 'Webcam Not Working on Windows 10',
    description: 'Fix webcam not working on windows 10 with clear steps for Windows 10 covering permissions, device selection, and drivers.',
    steps: [{"title":"Enable camera in Windows","description":"Enable camera in Windows 10 Privacy settings"},{"title":"Check camera permissions","description":"Check camera permissions"},{"title":"Update camera drivers","description":"Update camera drivers"},{"title":"Verify camera is selected","description":"Verify camera is selected"},{"title":"Restart your computer","description":"Restart your computer"}]
  })

  const steps = [{"title":"Enable camera in Windows","description":"Enable camera in Windows 10 Privacy settings"},{"title":"Check camera permissions","description":"Check camera permissions"},{"title":"Update camera drivers","description":"Update camera drivers"},{"title":"Verify camera is selected","description":"Verify camera is selected"},{"title":"Restart your computer","description":"Restart your computer"}]
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Webcam Not Working on Windows 10</h1>
            <p className="text-xl text-gray-600 max-w-3xl">
              Camera not detected on Windows 10. This guide covers all solutions, from permissions to driver updates.
            </p>
          </div>
          ...
          <IssueLinksPanel issue={{ slug: "webcam-not-working-windows-10", deviceType: "webcam", platform: "Windows 10", title: "Webcam Not Working on Windows 10" }} allIssues={issuesData} />
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            <QuickAnswerBox 
              problem="Camera not detected on Windows 10"
              platform="Windows 10"
              deviceType="webcam"
            />
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'webcam', platform: "Windows 10", slug: 'webcam-not-working-windows-10' }} />
