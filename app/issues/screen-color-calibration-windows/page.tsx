...
const faqs = [
  {
    "question": "Why is screen color calibration on windows?",
    "answer": "Screen colors look incorrect or need calibration on Windows. This usually happens due to permission settings, driver issues, or conflicts with other applications. Start by checking system permissions and ensuring the correct device is selected."
  },
  {
    "question": "How do I fix screen color calibration on windows?",
  ...
  {
    "question": "What causes screen color calibration on windows?",
  ...
  {
    "question": "Can I fix screen color calibration on windows without technical knowledge?",
...
export default function IssuePage() {
  const articleSchema = generateArticleSchema(
    'Screen Color Calibration on Windows - Complete Fix Guide',
    'Fix screen color calibration on windows. Step-by-step troubleshooting guide.',
    '/issues/screen-color-calibration-windows',
    new Date().toISOString(),
    new Date().toISOString()
  )

  const breadcrumbItems = [{"name":"Home","path":"/"},{"name":"Issues","path":"/issues"},{"name":"Windows device issues","path":"/hubs/windows-device-issues"},{"name":"Screen Color Calibration on Windows","path":"/issues/screen-color-calibration-windows"}]
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <article id="article-content" className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200 mt-8">
            ...
            <TroubleshootingMatrix issue={{ deviceType: 'screen', platform: "Windows", slug: 'screen-color-calibration-windows' }} />
