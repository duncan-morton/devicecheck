...
export const metadata: Metadata = genMeta({
  title: 'Microphone Not Detected on Windows 10, How to Fix',
  description: 'Fix microphone not detected on Windows 10. Troubleshoot device detection, driver issues, and permissions to get your mic working.',
  path: '/guides/microphone-not-detected-windows-10',
  keywords: [
    'microphone not detected windows 10',
    'mic not detected windows 10',
    'windows 10 microphone not working',
    'microphone not showing windows 10'
  ]
})

const faqs = [
  {
    question: 'Why is my microphone not detected on Windows 10?',
    answer: 'Microphone not detected issues on Windows 10 are usually caused by disabled privacy settings, outdated drivers, wrong input device selection, or hardware connection problems. Check Settings → Privacy → Microphone first, then verify device selection and drivers.'
  },
  {
    question: 'How do I enable microphone in Windows 10?',
    answer: 'Go to Settings → Privacy → Microphone → Ensure "Allow apps to access your microphone" is enabled. Also check Settings → System → Sound → Input to verify your microphone is selected and not muted.'
  }
]

export default function MicrophoneNotDetectedWindows10Page() {
  const articleSchema = generateArticleSchema(
    'Microphone Not Detected on Windows 10, How to Fix',
    'Fix microphone not detected on Windows 10. Troubleshoot device detection, driver issues, and permissions to get your mic working.',
  ...
  const breadcrumbs = generateBreadcrumbListSchema([
    ...
    { name: 'Microphone Not Detected on Windows 10', path: '/guides/microphone-not-detected-windows-10' }
  ])
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <article className="prose prose-slate max-w-none bg-white p-8 md:p-12 rounded-2xl border border-gray-200">
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Microphone Not Detected on Windows 10</h1>
            
            <p className="text-lg text-gray-700 mb-8">
              When Windows 10 doesn't detect your microphone, apps and websites can't access audio input. This page covers how to fix microphone detection issues on Windows 10. Check privacy settings first, then verify device selection and drivers.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Windows 10 privacy settings can block microphone access. Verify these are enabled.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Open Settings → Privacy → Microphone</li>
              <li>Ensure "Allow apps to access your microphone" is turned on</li>
              <li>Check "Allow desktop apps to access your microphone" if needed</li>
            ...
            <p className="text-gray-700 mb-4">
              Verify your microphone is selected and enabled in Windows 10 sound settings.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Right-click the speaker icon in the system tray</li>
              ...
              <li>Test the microphone using the "Test your microphone" feature</li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              ...
              <li>If it shows a yellow warning icon, right-click and select "Enable device"</li>
            ...
            <p className="text-gray-700 mb-4">
              Windows 10 includes an audio troubleshooter that can fix common issues.
            </p>
            <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-6">
              <li>Open Settings → Update & Security → Troubleshoot</li>
              <li>Click "Additional troubleshooters"</li>
              <li>Select "Playing Audio" or "Recording Audio"</li>
              <li>Click "Run the troubleshooter"</li>
            ...
            <p className="text-gray-700 mb-6">
              After trying these steps, use the <Link href="/mic" className="text-blue-600 hover:text-blue-800 font-semibold">online microphone test</Link> to verify Windows 10 detects your microphone. The test shows real-time volume levels and confirms device detection.
            </p>

            <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 my-8">
              <h3 className="font-semibold text-blue-900 mb-2">Related Guides</h3>
              <ul className="space-y-2 text-sm text-blue-800">
                <li><Link href="/guides/microphone-not-detected-windows-11" className="hover:text-blue-600 underline">Microphone Not Detected on Windows 11</Link></li>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-xl border border-gray-200">
              <p className="text-gray-700 mb-4">
                <strong>Next step:</strong> Test your microphone to confirm Windows 10 detects it.
              </p>
              <Link 
                href="/mic" 
