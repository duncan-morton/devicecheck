    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Online Microphone Test</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Test your microphone online to verify functionality, check input volume levels, and listen to a playback to ensure crystal clear audio quality.
          </p>
        </div>
        ...
        <article className="prose prose-slate max-w-none bg-white p-8 rounded-2xl border border-gray-200">
          <h2 className="text-2xl font-bold text-gray-800">How to Test Your Microphone</h2>
          <p>
            Our <strong>free online microphone test</strong> tool helps you verify if your mic is working correctly right from your browser.
          </p>
          <h3 className="text-lg font-bold text-gray-800">Common Microphone Issues</h3>
          <ul>
            <li><strong>Muted Input:</strong> Check hardware buttons or software settings.</li>
            <li><strong>Wrong Device:</strong> Your computer might be using the wrong mic.</li>
            <li><strong>Driver Issues:</strong> Outdated audio drivers can cause problems.</li>
          </ul>
        </article>
      </div>
    </div>
